/*******************************************************************************************
     ...
     Updated: 3/3/16 Added functionality to add status option for follow-up and archive using "statusEditor" and "statusDropDown" class 
...
define( [ "yasmf", "app/models/noteStorageSingleton",
  ...
  var TextNoteEditView = function() {
    ...
    self.renderToElement = function() {
	  ...
	  self._statusEditor = self.element.querySelector( ".statusDropdown" );
